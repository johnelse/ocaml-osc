...
(* OASIS_START *)
(* DO NOT EDIT (digest: 905b8e35e2084bc420e50a55fab698df) *)
(*
...
let setup_t =
  {
            ...
            [
               ...
               Library
                 ({
                   ...
                   {
                      lib_modules =
                        ["Osc"; "Osc_result"; "Osc_string"; "Osc_transport"];
                      lib_pack = false;
               ...
               Doc
                 ({
                  ...
                  },
                   {
                      ...
                      doc_title =
                        "Pure OCaml Open Sound Control implementation";
                      doc_authors = [];
                      doc_abstract = None;
                      doc_format = OtherDoc;
                      doc_data_files = [];
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "\001\179VlV\139k\225\183^\164\136\142\1496\140";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
