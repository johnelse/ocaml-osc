...
(* OASIS_START *)
(* DO NOT EDIT (digest: 2c40996483cd0f362f14f4752fe153c5) *)
(*
...
let setup_t =
  {
       ...
       [
          ...
          ("test_string",
            CustomPlugin.Test.main
              {
                 CustomPlugin.cmd_main =
                   [(OASISExpr.EBool true, ("$(test_string)", []))];
                 cmd_clean = [(OASISExpr.EBool true, None)];
                 cmd_distclean = [(OASISExpr.EBool true, None)]
              });
          ("test_unix",
            ...
            [
               ...
               Library
                 ({
                   ...
                   {
                      lib_modules = ["Osc"; "Osc_string"; "Osc_transport"];
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = None;
                      lib_findlib_name = Some "osc";
               ...
               Library
                 ({
                  ...
                  },
                   {
                      ...
                      bs_path = "unix";
                      bs_compiled_object = Best;
                      bs_build_depends = [InternalLibrary "osc"];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources = [];
                      bs_data_files = [];
                      bs_ccopt = [(OASISExpr.EBool true, [])];
               ...
               Executable
                 ({
                   ...
                   {exec_custom = false; exec_main_is = "test_string.ml"});
               Test
                 ({
                     cs_name = "test_string";
                     cs_data = PropList.Data.create ();
               ...
               Executable
                 ({
                   ...
                   {exec_custom = false; exec_main_is = "test_unix.ml"});
               Test
                 ({
                     cs_name = "test_unix";
                     cs_data = PropList.Data.create ();
               ...
               Executable
                 ({
                   ...
                   {
                      exec_custom = false;
                      exec_main_is = "test_interop_sclang.ml"
                   });
               Doc
                 ({
                     cs_name = "api";
                  ...
                  },
                   {
                      ...
                      doc_title =
                        "Pure OCaml Open Source Control implementation";
                      doc_authors = [];
                      doc_abstract = None;
                      doc_format = OtherDoc;
                      doc_data_files = [];
     ...
     oasis_version = "0.4.4";
     oasis_digest = Some "C;D\174\003o\026=\198n\175\218\165\011\227\155";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
