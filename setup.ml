...
(* OASIS_START *)
(* DO NOT EDIT (digest: 1da11896478a544a2fa6daadb3a951b3) *)
(*
...
let setup_t =
  {
            ...
            [
               ...
               Library
                 ({
                  ...
                  },
                   {
                      ...
                      bs_compiled_object = Best;
                      bs_build_depends =
                        [FindlibPackage ("lwt", None); InternalLibrary "osc"];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources = [];
                      bs_data_files = [];
                      bs_ccopt = [(OASISExpr.EBool true, [])];
               ...
               Executable
                 ({
                   ...
                   {exec_custom = false; exec_main_is = "osc_test.ml"});
               Test
                 ({
                     cs_name = "osc_test";
                     cs_data = PropList.Data.create ();
     ...
     oasis_version = "0.3.0";
     oasis_digest = Some "\168\031\220g\243\207e\2481%\208\031C\189\128Z";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
